...
def read_spike_trace(path, full_trace):
    ...
    # Depending on your Spike version, trampolines are either enabled or disabled.
    # No trampoline in Spike anymore
    # Check version 1.1.1-dev 4e17969c
    in_trampoline = False
    instr = None
    ...
    with open(path, "r") as handle:
        for line in handle:
            ...
            if commit_match:
                ...
                instr.gpr.append(
                    gpr_to_abi(groups["reg"].replace(" ", "")) + ":" + groups["val"]
                )
